...
class TestDblpEndpoint(Basetest):
    ...
    def test_toDblpUrl(self):
        ...
        test_params = [
            (
                "conf/aaai/2022",
                False,
                "https://dblp.org/db/conf/aaai/aaai2022",
            ),
            (
                "conf/aaai/2022",
                True,
                "https://dblp.org/db/conf/aaai/aaai2022.html",
            ),
            (
                "conf/aaai/aaai2022",
                False,
                None,
            ),  # entity id is expected not the url id
            (None, False, None),
            ("", False, None),
            (None, True, None),
            ("", True, None),
    ...
    def test_get_ceur_proceeding(self):
        ...
        self.assertEqual(
            "https://dblp.org/rec/conf/semweb/2022wikidata",
            volume.dblp_publication_id,
        )
